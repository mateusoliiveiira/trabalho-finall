...
// Verifica se o ID do termo foi passado via GET
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    echo "Termo atualizado com sucesso! <a href='formulario-termos.php'>Voltar para a lista de termos</a>";
    exit;
}

// Buscar dados do termo para editar
...
// Buscar matérias para o dropdown
...
<body>
    ...
    <a href="C:\xampp\htdocs\trabalho-finall\exatas\php\funcoes.php">Voltar para a lista de termos</a>
</body>
</html>
